const guarantees = [
  {
    title: "Engineers write the code.",
  ...
  },
  {
    ...
    body: "Every deploy, pipeline, and analysis runs the same way the next time you touch it. No 'works on my machine.'",
  },
  {
...
export function Approach() {
  return (
    ...
    >
      <div className="mx-auto max-w-350 px-6 py-24 lg:px-10 lg:py-32">
